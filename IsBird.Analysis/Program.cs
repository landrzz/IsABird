            ...
            try
            {
                ...
                var projects = new List<Solution>
                {
                    new Solution
                    {
                        ...
                        {
                            Path.Combine(path, "../IsBird/IsBird/src/IsBird.Droid/IsBird.Droid.csproj"),
                            Path.Combine(path, "../IsBird/IsBird/src/IsBird.csproj"),
                        },
                    },
                    ...
                    new Solution
                    {
                        ...
                        ProjectFiles = new List<string>
                        {
                            Path.Combine(path, "../IsBird/IsBird/src/IsBird.iOS/MvvmDirectors.iOS.csproj"),
                            Path.Combine(path, "../IsBird/IsBird/src/IsBird.csproj"),
                        },
                    },
