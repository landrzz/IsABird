...
namespace IsBird.iOS {
	...
	/// </summary>
	public class TheseAreBirdsInput : NSObject, IMLFeatureProvider
	{
	...
	/// </summary>
	public class TheseAreBirdsOutput : NSObject, IMLFeatureProvider
	{
		static readonly NSSet<NSString> featureNames = new NSSet<NSString> (
		...
		public TheseAreBirdsOutput (NSDictionary<NSObject, NSNumber> loss, string classLabel)
		{
			if (loss == null)
	...
	/// </summary>
	public class TheseAreBirds : NSObject
	{
		...
		TheseAreBirds (MLModel model)
		{
			this.model = model;
		}

		public static TheseAreBirds Create (NSUrl url, out NSError error)
		{
			if (url == null)
			...
			return new TheseAreBirds (model);
		}

		/// <summary>
		/// Make a prediction using the standard interface
		/// </summary>
		/// <param name="input">an instance of TheseAreBirdsInput to predict from</param>
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public TheseAreBirdsOutput GetPrediction (TheseAreBirdsInput input, out NSError error)
		{
			...
			return new TheseAreBirdsOutput (lossValue, classLabelValue);
		}
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public TheseAreBirdsOutput GetPrediction (CVPixelBuffer data, out NSError error)
		{
			var input = new TheseAreBirdsInput (data);
